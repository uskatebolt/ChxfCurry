    ...
    if (e1.get() != ""):
      try:
        if (int(e1.get()) <= 49):  #converts the Entry box from a string to an int so it can be compared to other ints
          ...
          messagebox.showinfo("TOO BIG", "Your input was too big")
          
      except:
          messagebox.showinfo("Error", "Input a whole number as a digit")
    if(e1.get() != ""):
      try:
        if (int(e1.get()) <=51):
          e111.insert(0, "1")
    ...
    if(e11.get() != ""):
      try:
        if (int(e11.get())==1):
          ...
          messagebox.showinfo("TOO BIG", "Enter from 1-7")
      except:
        messagebox.showinfo("Error", "Input a whole number as a digit")
    if(e22.get() != ""):  
      try:  
  ...
  if(e111.get() != ""): 
    try:
        if (int(e111.get())==1):
          ...
          messagebox.showinfo("TOO BIG", "Enter from 1-8")
    except:
      messagebox.showinfo("Error", "Input a whole number as a digit")
  if(e222.get() != ""): 
    try:  
...
def write_slogan():
    messagebox.showinfo("Instructions", "Enter a Number in any of the boxes and press the enter key to convert the numbers")
...
l11 = Label(root,text="Enter Standard Mark (Percentage)")
l11.pack()
...
e2 = Entry(root)
e2.bind('<Return>',runme1)
e2.pack()

e3 = Entry(root)
e3.bind('<Return>',runme1)
e3.pack()

e4 = Entry(root)
e4.bind('<Return>',runme1)
e4.pack()

e5 = Entry(root)
e5.bind('<Return>',runme1)
e5.pack()

e6 = Entry(root)
e6.bind('<Return>',runme1)
e6.pack()
...
e22 = Entry(root)
e22.bind('<Return>',runme11)
e22.pack()

e33 = Entry(root)
e33.bind('<Return>',runme11)
e33.pack()

e44 = Entry(root)
e44.bind('<Return>',runme11)
e44.pack()

e55 = Entry(root)
e55.bind('<Return>',runme11)
e55.pack()

e66 = Entry(root)
e66.bind('<Return>',runme11)
e66.pack()
...
e222 = Entry(root)
e222.bind('<Return>',runme111)
e222.pack()

e333 = Entry(root)
e333.bind('<Return>',runme111)
e333.pack()

e444 = Entry(root)
e444.bind('<Return>',runme111)
e444.pack()

e555 = Entry(root)
e555.bind('<Return>',runme111)
e555.pack()

e666 = Entry(root)
e666.bind('<Return>',runme111)
e666.pack()
